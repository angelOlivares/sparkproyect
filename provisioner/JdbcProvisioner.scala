...
object JdbcProvisioner {
  ...
  def main(args: Array[String]) {
    ...
    // Nos conectamos a la base de datos de postgres que esta en la google SQL y
    // le cargamos las tablas. Solo llenamos de datos la tabla user_metadata.
    val driver = "org.postgresql.Driver"
    val url = s"jdbc:postgresql://xx.xx.xxx.xxx:5432/postgres"
    val username = "xxxxxx"
    ...
    try {
      ...
      println("Dando de alta la información de usuarios en tabla user_metadata")
